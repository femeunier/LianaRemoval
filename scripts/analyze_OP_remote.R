...
saveRDS(object = list(QoF,
                      all_OP,
                      all_params),file = "output_removal.RDS")

# scp /home/femeunier/Documents/projects/LianaRemoval/scripts/analyze_OP_remote.R hpc:/data/gent/vo/000/gvo00074/felicien/R
