...
for (simu in seq(1,Nsimulations)){
  for (patch_type in seq(1,length(names_patch_t))){
    ...
    config_file <- file.path(run_ref,"config.xml")
...
# scp /home/femeunier/Documents/projects/LianaRemoval/scripts/analyze_patch_remote.R hpc:/data/gent/vo/000/gvo00074/felicien/R
